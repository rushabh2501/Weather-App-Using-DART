...
class HomeScreen extends StatefulWidget {
  ...
  _HomeScreenState createState() =>
      _HomeScreenState(); //Creates the mutable state for this widget at a given location in the tree.
}
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  @override
  void initState() {
    // method of class State which is used for one time initialization
    super.initState();
    _getData();
  }
  ...
  Future<void> _getData() async {
    ...
    weatherData.getWeatherData(); //weatherProvider
    _isLoading = false;
  }

  Future<void> _refreshData(BuildContext context) async {
    //reference to the location of a Widget in the tree
  ...
  Widget build(BuildContext context) {
    final weatherData = Provider.of<WeatherProvider>(
        context); //WeatherProvider is an abstract API class
    final myContext = Theme.of(context);
    final mediaQuery = MediaQuery.of(context);

    return SafeArea(
      //to adapt to phone size
      child: Scaffold(
